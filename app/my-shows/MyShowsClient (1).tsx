                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  ...
                  {!selectedYear && yearTimelineData.length > 1 && (
                    <button
                      ...
                      className={`w-10 h-10 rounded-full flex items-center justify-center transition-all bg-primary text-primary-foreground shadow-md hover:opacity-90 hover:shadow-lg ${
