      ...
      <tbody className="divide-y divide-border">
        {shows.map(show => (
          <tr key={show.show_id} className="hover:bg-muted/30">
            ...
            {/* Stacked Artist / Venue */}
            <td className="px-4 py-4">
              <div className="text-sm font-medium text-primary truncate">{show.artist_name}</div>
              <div className="text-xs text-muted-foreground truncate mt-0.5">{show.venue_name}</div>
            </td>
            {/* Spotify icon */}
